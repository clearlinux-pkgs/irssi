...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 00CCB587DDBEF0E1' gpg.status
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737562384
...
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dwith-perl-lib=vendor \
